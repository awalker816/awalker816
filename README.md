<h1>👩🏾‍💻 About Me</h1>
  ...
  Hi, I'm April Walker -- a Cybersecurity & Information Assurance student at Western Governors University, proudly CompTIA CySA+, Security+, Network+, and A+ certified. 🚀
    
  I’m passionate about threat detection, incident response, and security monitoring. Through hands-on labs, virtual environments, and platforms like Wireshark, VirtualBox, and TryHackMe, I’m strengthening my skills in:: 
...
🔹 IDS/IPS detection engineering, rule tuning, and network segmentation labs
...
- [CompTIA CySA+](https://www.credly.com/badges/208de6b1-82fe-4f1b-930c-2ae5b72e8183/public_url)
...
- Completing advanced coursework for CCSP and CompTIA PenTest+, with a focus on cloud security, risk management, and offensive security fundamentals
- Preparing to complete a cybersecurity capstone focused on applied security analysis and real-world defensive scenarios
- Applying threat detection concepts through completed hands-on labs, including IDS/IPS deployment, SIEM log analysis, alert triage, and network segmentation
- Continuing hands-on practice in packet analysis and incident response using Wireshark and TryHackMe
...
- Threat Detection Lab: Implemented IDS/IPS monitoring, analyzed security events, validated alerts, and documented findings in a controlled lab environment  
  🔗 https://github.com/awalker816/snort-ids-lab
